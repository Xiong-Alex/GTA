...
import { getFaqs } from '../../lib/local-data';
    ...
    <SafeAreaView style={styles.container} edges={['top']}>
      <View style={styles.headerContainer}>
        ...
        <View style={styles.heroCard}>
          <Text style={styles.heroTitle}>Find quick answers to common employee travel and policy questions.</Text>
        </View>
      </View>
      ...
      <ScrollView style={styles.scrollView} contentContainerStyle={styles.content}>
          ...
          filteredFaqs.map((faq) => (
            ...
            >
              <View style={styles.faqHeader}>
                ...
                <Ionicons name={expandedId === faq.id ? 'chevron-up' : 'chevron-down'} size={20} color={COLORS.gray} />
              </View>
              {expandedId === faq.id && (
        ...
        <View style={styles.contactCard}>
          ...
          <Text style={styles.contactTitle}>Need something more specific?</Text>
          <Text style={styles.contactSubtitle}>Use the demo assistant for instant answers based on the current prototype.</Text>
          <TouchableOpacity style={styles.contactBtn} onPress={() => router.push('/support/chat')}>
            <Text style={styles.contactBtnText}>Open Assistant</Text>
...
const styles = StyleSheet.create({
  ...
  categoryScroll: { maxHeight: 64, backgroundColor: COLORS.background },
  categoryContent: { paddingHorizontal: 16, paddingVertical: 12, gap: 10, flexDirection: 'row' },
  categoryChip: {
    flexDirection: 'row',
    alignItems: 'center',
    paddingHorizontal: 16,
  ...
  faqQuestion: { flex: 1, fontSize: 15, fontWeight: '700', color: COLORS.black, lineHeight: 22 },
  faqAnswer: {
    paddingHorizontal: 16,
    paddingBottom: 16,
    borderTopWidth: 1,
  ...
  faqAnswerText: { fontSize: 14, color: COLORS.gray, lineHeight: 22, paddingTop: 12 },
  faqCategory: {
    flexDirection: 'row',
    alignItems: 'center',
  ...
  faqCategoryText: { fontSize: 12, fontWeight: '700' },
  contactCard: {
    backgroundColor: COLORS.primary,
    borderRadius: 22,
    padding: 24,
  ...
  contactTitle: { fontSize: 18, fontWeight: '700', color: COLORS.white, textAlign: 'center' },
  contactSubtitle: { fontSize: 14, color: COLORS.lightBlue, marginTop: 6, textAlign: 'center', lineHeight: 20 },
  contactBtn: {
    flexDirection: 'row',
    alignItems: 'center',
    backgroundColor: COLORS.white,
